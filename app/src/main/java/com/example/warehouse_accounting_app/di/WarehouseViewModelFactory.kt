    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        ...
        return when {
            ...
            modelClass.isAssignableFrom(CategoryListViewModel::class.java) ->
                CategoryListViewModel(c.getCategoriesUseCase, c.deleteCategoryUseCase, c.getCurrentUserUseCase) as T
            modelClass.isAssignableFrom(CategoryEditViewModel::class.java) ->
                CategoryEditViewModel(c.getCategoryByIdUseCase, c.createCategoryUseCase, c.updateCategoryUseCase) as T
            modelClass.isAssignableFrom(ProductListViewModel::class.java) ->
                ProductListViewModel(c.getProductsUseCase, c.deleteProductUseCase, c.getCurrentUserUseCase, c.getCategoriesUseCase) as T
            ...
            modelClass.isAssignableFrom(ProductEditViewModel::class.java) ->
                ProductEditViewModel(c.getProductDetailsUseCase, c.createProductUseCase, c.updateProductUseCase, c.getCategoriesUseCase) as T
            ...
            modelClass.isAssignableFrom(ReportsViewModel::class.java) ->
                ReportsViewModel(
                    c.getStockSummaryReportUseCase,
                    c.getLowStockReportUseCase,
                    c.getOperationsReportUseCase,
                    c.getStockValueReportUseCase,
                ) as T
